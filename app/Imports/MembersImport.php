...
class MembersImport implements ToCollection, WithHeadingRow, WithBatchInserts, WithChunkReading
{
    ...
    private function normalizeColumnNames($row)
    {
        ...
        $columnMapping = [
            ...
            'other_names' => ['others', 'other_names', 'middle_name', 'other_name'],
            'birth_day' => ['day_of_birth', 'birth_day', 'day'],
            'birth_month' => ['month_of_birth', 'birth_month', 'month'],
            'gender' => ['gender', 'sex'],
            'emergency_contact_details' => ['emergency_contact_name___phone_number', 'emergency_contact_name_phone_number', 'emergency_contact', 'emergency_contact_details'],
            ...
            'lga_of_origin' => ['local_government', 'local_government_of_origin', 'lga_of_origin', 'lga'],
            'state_of_residence' => ['state_of_residence', 'state_residence'],
            'city_of_residence' => ['city_of_residence', 'city_residence'],
            'address' => ['street_name_number', 'street_no_and_name_eg_2_korogboji', 'street_no_and_name', 'address', 'street'],
            'profession' => ['profession_occupation', 'professionoccupation', 'vocation_occupation', 'vocation', 'profession', 'occupation'],
