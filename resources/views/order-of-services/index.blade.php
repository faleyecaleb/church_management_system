...
<div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-3 text-center sm:mt-5">
                        <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">
                            Import Order of Service
                        </h3>
                        <div class="mt-2 text-sm text-gray-500">
                            <p>Upload an Excel or CSV file to bulk import items.</p>
                            <a href="{{ route('services.order-of-services.template') }}" class="text-blue-600 hover:underline mt-2 inline-block">
                                Download Template
                            </a>
                        </div>
                    </div>
                </div>
                <form action="{{ route('services.order-of-services.import', $service->id) }}" method="POST" enctype="multipart/form-data" class="mt-5 sm:mt-6">
                    @csrf
                    <div>
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600 justify-center">
                                    <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                        ...
                                        <input id="file-upload" name="file" type="file" class="sr-only" required accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                                    </label>
    ...
    <script>
        document.getElementById('file-upload').addEventListener('change', function(e) {
            ...
            document.getElementById('file-name-display').classList.add('text-green-600');
            document.getElementById('file-name-display').classList.remove('text-gray-500');
        });
    </script>
