...
@section('title', 'Create Prayer Request')
@section('header', 'Create Prayer Request')
...
<div class="space-y-6">
    ...
    <div class="bg-white/70 backdrop-blur-sm rounded-2xl border border-white/20 p-6 shadow-lg">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Create Prayer Request</h1>
                <p class="mt-1 text-sm text-gray-600">Share your prayer needs with the community</p>
            </div>
        ...
        <form action="{{ route('prayer-requests.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="prayer_frequency" 
                        ...
                        <option value="1" {{ old('prayer_frequency') == '1' ? 'selected' : '' }}>Daily</option>
                        <option value="3" {{ old('prayer_frequency') == '3' ? 'selected' : '' }}>Every 3 days</option>
                        <option value="7" {{ old('prayer_frequency') == '7' ? 'selected' : '' }}>Weekly</option>
                        <option value="14" {{ old('prayer_frequency') == '14' ? 'selected' : '' }}>Bi-weekly</option>
                        <option value="30" {{ old('prayer_frequency') == '30' ? 'selected' : '' }}>Monthly</option>
                    </select>
            ...
            <div>
                ...
                <textarea name="description" 
                          ...
                          required
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder="Share the details of your prayer request. Be as specific as you feel comfortable being...">{{ old('description') }}</textarea>
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 class="text-sm font-medium text-blue-800 mb-2">Prayer Request Guidelines</h4>
                <ul class="text-xs text-blue-700 space-y-1">
                    <li>• Be respectful and appropriate in your language</li>
                    <li>• Share only what you're comfortable with others knowing</li>
                    <li>• Consider using initials or general terms for sensitive situations</li>
                    <li>• Remember that public requests can be seen by all church members</li>
                    <li>• Private requests are only visible to you and church administrators</li>
                </ul>
            </div>
