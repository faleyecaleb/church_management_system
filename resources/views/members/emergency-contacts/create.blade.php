...
<div class="max-w-7xl mx-auto py-6">
    ...
    <form action="{{ route('members.emergency-contacts.store', $member) }}" method="POST" class="space-y-8 divide-y divide-gray-200">
        @csrf
        <x-validation-errors />
                    ...
                    <div class="sm:col-span-6">
                        ...
                        <div class="mt-1">
                            <textarea name="address" id="address" rows="3"
                                      class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md">{{ old('address') }}</textarea>
                        </div>
                    </div>
        ...
        <div class="pt-5">
            <div class="flex justify-end">
                ...
                <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Save Contact</button>
            </div>
        </div>
    </form>
</div>
