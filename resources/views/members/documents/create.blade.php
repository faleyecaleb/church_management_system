...
@section('header', 'Upload Member Document')

@section('content')
<div class="max-w-7xl mx-auto py-6">
    <x-success-message />

    <form action="{{ route('members.documents.store', $member) }}" method="POST" enctype="multipart/form-data" class="space-y-8 divide-y divide-gray-200">
        @csrf
        <x-validation-errors />
        ...
        <div class="space-y-8 divide-y divide-gray-200">
            <div>
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Please provide the details of the document you are uploading.</p>
                </div>
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-1">
                            <select name="document_type" id="document_type"
                                ...
                                <option value="medical" {{ old('document_type') === 'medical' ? 'selected' : '' }}>Medical Record</option>
        ...
        <div class="pt-5">
            <div class="flex justify-end">
                ...
                <button type="submit" class="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Upload Document</button>
            </div>
        </div>
    </form>
</div>
